...
Note:  A follow-up challenge is to solve it in O(n) time and O(1) extra space.
The O(1) space solution requires modifying the list in place by reversing the second half, then restoring it — handle this carefully in a real system.
